<section class="pt-0 mt-5">
    @if ($recentNews->count() > 0 || $popularNews->count() > 0)
    ...
    <!-- Post news carousel -->
    @if ($categorySectionOne->isNotEmpty())
    ...
    <!-- Post news carousel -->
    @if ($categorySectionTwo->isNotEmpty())
        <div class="container mt-4">
            <div class="row">
                <div class="col-md-12">
                    <aside class="wrapper__list__article">
                ...
                <div class="col-md-8">
                    @if ($categorySectionThree->isNotEmpty())
                        <aside class="wrapper__list__article mb-0">
                            <h4 class="border_section">{{ @$categorySectionThree->first()->category->name }}
                            </h4>
                            <div class="row">
                                <div class="col-md-6">
                    ...
                    @if ($categorySectionFour->isNotEmpty())
                        <aside class="wrapper__list__article mt-5">
                            <h4 class="border_section">{{ @$categorySectionFour->first()->category->name }}
                            </h4>
                            <div class="wrapp__list__article-responsive">
                                                    ...
                                                    <div class="card__post__content  ">
                                                        ...
                                                        <div class="card__post__title">
                                                            ...
                                                            <p class="d-none d-lg-block d-xl-block mb-0">
                                                                {!! Str::words(strip_tags($sectionFourNews->content), 10) !!}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
